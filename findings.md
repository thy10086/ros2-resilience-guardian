...
- The dashboard now exposes the warehouse case as a first-class built-in sample. Its metadata card shows robot, mission phase, ROS 2 topics, threats and Jev summary; a one-click action transfers only the bounded summary to the Jev page. The replay endpoint and safety table remain deterministic and independent of Jev.
